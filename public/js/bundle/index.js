...
if (queryString) {
    ...
    if (isPreviousSignup === "true") (0, _alerts.showAlert)("success", // 'You have already done Sign up before. If you have not set the password yet then please fill the form',
    "Please Set Your Password!", 20);
}
